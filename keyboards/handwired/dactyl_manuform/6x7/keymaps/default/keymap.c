...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x7(
        ...
        _______ , KC_TAB  , KC_Q    , KC_W    , KC_E    , KC_R    , KC_T    ,    KC_B    , KC_Y    , KC_U    , KC_I    , KC_O    , KC_P    , KC_B    ,
        _______ , KC_LSFT , KC_A    , KC_S    , KC_D    , KC_F    , KC_G    ,    KC_C    , KC_H    , KC_J    , KC_K    , KC_L    , KC_SCLN , KC_C    ,
